...
// Accept bytes array and try to cast into `objectType`
// that can one of the kubernetes Kind.
func (k8sEngine *Engine) BytesToEngineObject(
	objectName string, 
    objectManifestBytes []byte,
	objectType interface{},
) error {
	var err error

	if err = yaml.Unmarshal(objectManifestBytes, objectType); err != nil {
...
// that can one of the kubernetes Kind.
func (k8sEngine *Engine) FileToEngineObject(
