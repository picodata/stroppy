...
func (e *Engine) installSSHKeyFileOnMaster() (err error) {
	...
	copyPrivateKeyCmd := exec.Command("scp", "-i", e.sshKeyFileName, "-o", "StrictHostKeyChecking=no", e.sshKeyFileName, mastersConnectionString)
...
// CollectMonitoringData собирает данные мониторинга.
